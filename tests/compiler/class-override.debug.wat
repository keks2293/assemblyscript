(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 516))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33284))
 (global $~lib/memory/__heap_base i32 (i32.const 33284))
 (memory $0 1)
 ...
 (data $8 (i32.const 412) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\"\00\00\00c\00l\00a\00s\00s\00-\00o\00v\00e\00r\00r\00i\00d\00e\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 480) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $class-override/A#f (param $this i32) (param $a i32) (result i32)
  local.get $a
  i32.const 1
  i32.add
  return
 )
 (func $start:class-override
  memory.size
  i32.const 16
  i32.shl
  global.get $~lib/memory/__heap_base
  ...
  global.set $~lib/rt/itcms/fromSpace
  i32.const 0
  call $class-override/D#constructor
 ...
 (func $class-override/A#f@override (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  block $default
   block $case1
    block $case0
 ...
 (func $class-override/A#constructor (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
 ...
 (func $class-override/B#constructor (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  i32.store offset=4
  local.get $1
  call $class-override/A#constructor
  local.tee $this
  i32.store
  local.get $this
  local.set $1
 ...
 (func $class-override/C#constructor (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  i32.store offset=4
  local.get $1
  call $class-override/B#constructor
  local.tee $this
  i32.store
  local.get $this
  local.set $1
 ...
 (func $class-override/D#constructor (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  i32.store offset=4
  local.get $1
  call $class-override/C#constructor
  local.tee $this
  i32.store
  local.get $this
  local.set $1
 ...
 (func $class-override/fn (param $n i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $1
  local.get $n
  call $class-override/A#f@override
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
 ...
 (func $class-override/B#f (param $this i32) (param $a i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $class-override/C#f (param $this i32) (param $a i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
