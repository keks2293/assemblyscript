(module
 ...
 (data $8 (i32.const 412) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00&\00\00\00d\00u\00p\00l\00i\00c\00a\00t\00e\00-\00f\00i\00e\00l\00d\00s\00.\00t\00s\00\00\00\00\00\00\00")
 (data $9 (i32.const 480) "\0b\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "memory" (memory $0))
 (start $~start)
 (func $duplicate-fields/A#set:bar (param $this i32) (param $bar i32)
  local.get $this
  local.get $bar
  i32.store
 )
 ...
 (func $duplicate-fields/B#set:bar (param $this i32) (param $bar i32)
  local.get $this
  local.get $bar
  i32.store
 )
 (func $duplicate-fields/B#get:bar (param $this i32) (result i32)
  local.get $this
  i32.load
 )
 ...
 (func $duplicate-fields/A2#set:bar (param $this i32) (param $bar i32)
  local.get $this
  local.get $bar
  i32.store
  local.get $this
 ...
 (func $duplicate-fields/B2#set:bar (param $this i32) (param $bar i32)
  local.get $this
  local.get $bar
  i32.store
  local.get $this
 ...
 (func $duplicate-fields/Foo#set:foo (param $this i32) (param $foo i32)
  local.get $this
  local.get $foo
  i32.store
 )
 (func $duplicate-fields/B2#get:bar (param $this i32) (result i32)
  local.get $this
  i32.load
 )
 (func $duplicate-fields/Foo#get:foo (param $this i32) (result i32)
  local.get $this
  i32.load
 )
           ...
           block $~lib/string/String
            block $~lib/arraybuffer/ArrayBuffer
             block $~lib/object/Object
              ...
              i32.sub
              i32.load
              br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $duplicate-fields/A $duplicate-fields/B $duplicate-fields/A2 $duplicate-fields/Foo $duplicate-fields/B2 $duplicate-fields/B3 $duplicate-fields/A3 $invalid
             end
             return
            end
            return
 ...
 (func $start:duplicate-fields
  ...
  i32.store
  local.get $0
  call $duplicate-fields/B#get:bar
  i32.const 10
  i32.eq
  i32.eqz
  if
  ...
  i32.store offset=4
  local.get $0
  call $duplicate-fields/B2#get:bar
  local.set $0
  global.get $~lib/memory/__stack_pointer
  local.get $0
  i32.store
  local.get $0
  call $duplicate-fields/Foo#get:foo
  i32.const 1
  i32.eq
  i32.eqz
  if
