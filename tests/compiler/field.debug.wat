(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 480))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33248))
 (global $~lib/memory/__heap_base i32 (i32.const 33248))
 (memory $0 1)
 ...
 (data $9 (i32.const 448) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\02A\00\00\02\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $field/NoStaticConflict#set:a (param $this i32) (param $a i32)
  local.get $this
  local.get $a
  i32.store
  local.get $this
 ...
 (func $field/NoStaticConflict.a (param $v i32)
 )
 ...
 (func $field/NoStaticConflict~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  local.get $1
  call $~lib/object/Object~visit
