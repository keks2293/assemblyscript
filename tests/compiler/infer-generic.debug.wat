(module
 ...
 (func $start:infer-generic~anonymous|0 (param $acc i32) (param $cur f32) (param $$2 i32) (param $$3 i32) (result i32)
  local.get $acc
  if (result i32)
   local.get $cur
   f32.const 0
 ...
 (func $infer-generic/Ref#set:x (param $this i32) (param $x i32)
  local.get $this
  local.get $x
  i32.store
 )
 ...
 (func $infer-generic/test1 (param $arr f32) (result f32)
  local.get $arr
  call $infer-generic/inferPlain<f32>
  return
 )
 (func $infer-generic/inferEncapsulatedClass<f32> (param $arr i32) (result i32)
  local.get $arr
  return
 )
 ...
 (func $~lib/function/Function<%28f32%29=>f64>#get:_env (param $this i32) (result i32)
  local.get $this
  i32.load offset=4
 )
