(module
 ...
 (memory $0 1)
 (data $0 (i32.const 12) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\16\00\00\00i\00n\00l\00i\00n\00i\00n\00g\00.\00t\00s\00\00\00\00\00\00\00")
 (data $1 (i32.const 60) "\1c\00\00\00\00\00\00\00\00\00\00\00\04\00\00\00\08\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (data $10 (i32.const 496) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00")
 (table $0 2 2 funcref)
 ...
 (func $inlining/func_fe~anonymous|0 (param $a i32) (result i32)
  local.get $a
 )
 (func $inlining/test_funcs
  ...
  i32.eq
  drop
  block $inlining/func_ii_opt|inlined.3 (result i32)
   block $inlining/func_ii_opt|inlined.2 (result i32)
    i32.const 1
    local.set $a|7
    local.get $a|7
    br $inlining/func_ii_opt|inlined.2
   end
   local.set $a|8
   local.get $a|8
   br $inlining/func_ii_opt|inlined.3
  end
  i32.const 1
  i32.eq
  drop
 ...
 (func $inlining/Baz#set:b (param $this i32) (param $b i32)
  local.get $this
  local.get $b
  i32.store offset=4
 )
 ...
 (func $inlining/Baz#get:b (param $this i32) (result i32)
  local.get $this
  i32.load offset=4
 )
 (func $inlining/Bar#get:d (param $this i32) (result i32)
  local.get $this
  i32.load offset=8
 )
 (func $inlining/Bar#get:e (param $this i32) (result i32)
  local.get $this
  i32.load offset=12
 )
 (func $start:inlining
