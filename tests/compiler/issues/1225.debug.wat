(module
 ...
 (data $8 (i32.const 412) ",\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\1c\00\00\00i\00s\00s\00u\00e\00s\00/\001\002\002\005\00.\00t\00s\00")
 ...
 (start $~start)
 (func $issues/1225/X#get:x (param $this i32) (result i32)
  local.get $this
  i32.load offset=8
 )
 (func $issues/1225/X#set:viaThis (param $this i32) (param $viaThis i32)
  local.get $this
  local.get $viaThis
  i32.store offset=4
 )
 (func $issues/1225/X#set:normal (param $this i32) (param $normal i32)
  local.get $this
  local.get $normal
  i32.store
 )
 ...
 (func $issues/1225/X#get:viaThis (param $this i32) (result i32)
  local.get $this
  i32.load offset=4
 )
 ...
 (func $issues/1225/viaThis (result i32)
  ...
  i32.store
  local.get $0
  call $issues/1225/X#get:viaThis
  local.set $0
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
