(module
 ...
 (data $8 (i32.const 416) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $new/Ref#get:ref (param $this i32) (result i32)
  local.get $this
  return
 )
 (func $new/Gen<i32>#get:gen (param $this i32) (result i32)
  local.get $this
  return
 )
