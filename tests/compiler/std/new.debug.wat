(module
 ...
 (start $~start)
 (func $std/new/AClass#get:aField (param $this i32) (result i32)
  local.get $this
  i32.load
 )
 (func $std/new/AClass#set:aField (param $this i32) (param $aField i32)
  local.get $this
  local.get $aField
  i32.store
 )
 (func $std/new/AClass#set:anotherField (param $this i32) (param $anotherField f32)
  local.get $this
