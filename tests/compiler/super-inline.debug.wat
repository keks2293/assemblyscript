(module
 ...
 (func $super-inline/Foo#a (param $this i32) (result i32)
  i32.const 1
  return
 )
 (func $super-inline/Foo#a@override (param $0 i32) (result i32)
  (local $1 i32)
  block $default
   block $case0
    local.get $0
 ...
 (func $super-inline/Bar#a (param $this i32) (result i32)
  ...
  i32.const 0
  i32.store
  block $super-inline/Foo#a|inlined.0 (result i32)
   global.get $~lib/memory/__stack_pointer
   local.get $this
   local.tee $this|1
   i32.store
   i32.const 1
   br $super-inline/Foo#a|inlined.0
  end
  local.set $2
  global.get $~lib/memory/__stack_pointer
  i32.const 4
